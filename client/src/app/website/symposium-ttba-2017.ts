	...
	'programme': {
		...
		'schedules': [{
			...
			'speakers': [
				...
				speakersObj['Ting Ting Wu'],
				speakersObj['Ming-Ting Tsai'],
				speakersObj['Chia-Yu Chung'],
				speakersObj['Jingyuan Zhang'],
				speakersObj['Sean Huang'],
				speakersObj['Kelly Miao'],
				speakersObj['Shaobo Zhu'],
				speakersObj['Shao-Yung Lin'],
				speakersObj['Sophie Hsiao'],
				speakersObj['Kevin Yang'],
				speakersObj['Chen-Ching Yuan'],
				speakersObj['Liang-Yuan Chiu'],
				speakersObj['Ya-Ping Hsieh'],
				speakersObj['Mario Hofmann'],
			],
		}, {
